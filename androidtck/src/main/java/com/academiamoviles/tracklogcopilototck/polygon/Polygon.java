package com.academiamoviles.tracklogcopilototck.polygon;
...
public class Polygon
{
    ...
    public static class Builder
    {
        ...
        /**
         * Add a list vertex points of the polygon.<br>
         * It is very important to add the vertexes by order, like you were drawing them one by one.
         *
         * @param points
         *            The list vertex point
         * @return The builder
         */
        public Builder addVertex(List<Point> points)
        {
